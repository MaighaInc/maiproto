...
**Quick Start**:
- Local: See [node/database/postgres/README.md](node/database/postgres/README.md) for setup instructions
- Docker: See [node/database/postgres/README.md](node/database/postgres/README.md) for Docker deployment
